...
func Build() {
	banner := figure.NewFigure("Collector", "", true)
	banner.Print()
...
func (Docker) Build() error {
	...
	return sh.RunV("docker", "build",
		...
		"-t", "iocplatform-collector:latest",
		".")
}
...
func (Bin) Collector() error {
	return goBuild("github.com/iocplatform/collector/cli/collector", "collector")
}
...
func goBuild(packageName, out string) error {
	...
	varsSetByLinker := map[string]string{
		"github.com/iocplatform/collector/internal/version.Version":   tag(),
		"github.com/iocplatform/collector/internal/version.Revision":  hash(),
		"github.com/iocplatform/collector/internal/version.Branch":    branch(),
		"github.com/iocplatform/collector/internal/version.BuildUser": os.Getenv("USER"),
		"github.com/iocplatform/collector/internal/version.BuildDate": time.Now().Format(time.RFC3339),
		"github.com/iocplatform/collector/internal/version.GoVersion": runtime.Version(),
	}
